...
public interface OrderRepository extends JpaRepository<Order, Long>, JpaSpecificationExecutor<Order> {
    ...
    @Query("SELECT o.paymentStatus FROM Order o WHERE o.code = :orderCode AND o.user.id = :userId")
    PaymentStatus findPaymentStatusByUserIdAndCode(@Param("userId") Long userId, @Param("orderCode") String orderCode);
